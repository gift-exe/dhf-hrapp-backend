...
class User(Base):
    ...
    sent_messages = relationship("Message", back_populates="sender", foreign_keys="[Message.sender_id]", cascade="all, delete, delete-orphan")
    sent_early_closures = relationship("EarlyClosure", back_populates="sender", foreign_keys="[EarlyClosure.sender_id]", cascade="all, delete, delete-orphan")
